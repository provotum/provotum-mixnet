...
mod tests {
    ...
    #[test]
    fn it_should_create_lg_system_twice() {
        let sk_str = "";
        let (params, sk, pk) = Helper::setup_lg_system();
        let (params2, sk2, pk2) = Helper::setup_lg_system_with_sk(sk_str.as_bytes());
